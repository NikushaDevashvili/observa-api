...
async function runSimulation() {
  ...
  console.log(`  1. View traces at: ${API_URL.replace(':3000', ':3001')}/dashboard/traces`);
  console.log(`  2. View conversations at: ${API_URL.replace(':3000', ':3001')}/dashboard/conversations`);
  console.log(`  3. Check analytics at: ${API_URL.replace(':3000', ':3001')}/dashboard/analytics\n`);
}
